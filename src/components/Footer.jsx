      ...
      <div className='max-w-[1240px] mx-auto py-8 px-4 grid grid-cols-1 lg:grid-cols-5 gap-8 text-gray-300'>
        ...
        <div>
            ...
            <ul>
                ...
                <li className='py-2 text-sm cursor-pointer' onClick={() => setModalOpen(true)}>Aviso legal</li>
            </ul>
        </div>
      </div>
...
figura,
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button onClick={() => setModalOpen(false)} type="button" className="mt-3 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                  Cerrar
                </button>
              </div>
            </div>
